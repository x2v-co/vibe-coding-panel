...
const fixture = ({version=sha,js=sha+' /screenshots/runtime/remote-mobile.png',css='body{}',assetStatus=200}={}) => async url => {
  ...
  if(path==='/remote') return new Response('<div id="root"></div>');
