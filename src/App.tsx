...
function LandingPage() {
  return <div className="site-shell">
    <header className="site-nav"><a className="site-brand" href="/"><span className="site-mark"><Sparkles size={16} /></span><span>VIBE PANEL</span></a><nav><a href="#how-it-works">怎么工作</a><a href="/download">下载 Connector</a><a className="site-nav-action" href="/api/desktop-controller/view">遥控器</a><a className="site-nav-action" href="/app">打开面板 <ChevronRight size={15} /></a></nav></header>
    <main>
      <section className="site-hero"><div className="site-hero-copy"><p className="site-kicker">A CONTROL SURFACE FOR YOUR AGENT</p><h1>把 Agent，<br /><em>握在手里。</em></h1><p>不用买外设。用手机的语音和几个关键按键，控制电脑上的 Codex 或 Claude Code。</p><div className="site-hero-actions"><a className="site-primary-action" href="/app">打开控制面板 <ArrowRight size={17} /></a><a className="site-secondary-action" href="/api/desktop-controller/view">打开手机遥控器 <ArrowRight size={17} /></a><a className="site-secondary-action" href="/download">下载电脑 Connector</a></div><span className="site-note"><ShieldCheck size={14} />Agent 在电脑运行；内容经 Relay 转发</span></div><div className="site-hero-device"><div className="site-device-label">VIBE PANEL / CODEX MICRO</div><img src="/screenshots/runtime/panel-desktop.png" alt="Vibe Panel 控制面板运行截图" /></div></section>
      <section className="site-how" id="remote"><div><p className="site-kicker">PHONE AS A REMOTE</p><h2>说在手机上，<br />接着在电脑做。</h2></div><div className="site-steps"><div><strong>遥控电脑当前会话</strong><p>用语音和按键向电脑追加输入，完整草稿与回复留在电脑；按下发送才会提交。</p></div><div><strong>已经连接过？直接打开</strong><p>使用原来配对的浏览器打开遥控器。首次使用先在电脑启动控制中心，再扫描电脑提供的二维码，在遥控器设置中完成配对。</p><a className="site-primary-action" href="/api/desktop-controller/view">打开手机遥控器 <ArrowRight size={17} /></a></div><div><strong>电脑如何启动</strong><p>Connector 的控制中心使用 <code>--controller</code> 启动选项；原生 App 控制限 macOS，Claude Code 托管会话也支持 Windows 和 Linux。</p><a className="site-secondary-action" href="/download#controller-setup">查看启动方式 <ArrowRight size={17} /></a></div></div></section>
    ...
    <footer className="site-footer"><span>VIBE PANEL / 2026 · <a href="https://x2v.co" target="_blank" rel="noreferrer">X2V</a> · <a href="https://toolkit.fun" target="_blank" rel="noreferrer">Toolkit</a></span><span><a href="/api/desktop-controller/view">遥控器</a><a href="/download">下载</a><a href="https://github.com/x2v-co/vibe-coding-panel" target="_blank" rel="noreferrer">GitHub</a><a href="https://aiplans.dev" target="_blank" rel="noreferrer">更多产品</a><a href="/privacy/">隐私</a><a href="/terms/">条款</a></span></footer>
  </div>;
}

function DownloadPage() {
  return <div className="site-shell download-shell">
    <header className="site-nav"><a className="site-brand" href="/"><span className="site-mark"><Sparkles size={16} /></span><span>VIBE PANEL</span></a><nav><a href="/">项目介绍</a><a className="site-nav-action" href="/api/desktop-controller/view">遥控器</a><a className="site-nav-action" href="/app">打开面板 <ChevronRight size={15} /></a></nav></header>
