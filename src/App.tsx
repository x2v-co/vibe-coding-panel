...
function LandingPage() {
  return <div className="site-shell">
    <header className="site-nav"><a className="site-brand" href="/"><span className="site-mark"><Sparkles size={16} /></span><span>VIBE PANEL</span></a><nav><a href="#how-it-works">怎么工作</a><a href="/remote">Vibe Remote</a><a href="/download">下载 Connector</a><a className="site-nav-action" href="/app">打开面板 <ChevronRight size={15} /></a></nav></header>
    <main>
      <section className="site-hero"><div className="site-hero-copy"><p className="site-kicker">VIBE PANEL / AGENT WORKSPACE</p><h1>在电脑上，<br /><em>把 Agent 做成工作流。</em></h1><p>连接本机的 Codex 或 Claude Code，在项目里创建任务、查看过程并继续原生会话。手机遥控由配套的 Vibe Remote 提供。</p><div className="site-hero-actions"><a className="site-primary-action" href="/app">打开 Vibe Panel <ArrowRight size={17} /></a><a className="site-secondary-action" href="/download">下载 Connector</a></div><span className="site-note"><ShieldCheck size={14} />Agent 和项目运行在你的电脑上</span></div><div className="site-hero-device"><div className="site-device-label">VIBE PANEL / WORKSPACE</div><img src="/screenshots/runtime/panel-desktop.png" alt="Vibe Panel 电脑工作台" /></div></section>
      <section className="site-proof"><div><strong>01</strong><span>连接</span><p>发现本机已登录的 Agent 和原生会话</p></div><div><strong>02</strong><span>组织</span><p>选择项目目录，创建并继续任务</p></div><div><strong>03</strong><span>交付</span><p>查看过程、结果和下一步行动</p></div></section>
      <section className="site-how" id="how-it-works"><div><p className="site-kicker">THREE STEPS</p><h2>从电脑开始，<br />让 Agent 进入项目。</h2></div><div className="site-steps"><div><b>1</b><strong>启动 Connector</strong><p>解压后启动 Connector，它会检查 Codex、Claude Code 和语音组件。</p></div><div><b>2</b><strong>连接 Agent 与 Workspace</strong><p>选择本机 Agent 和项目目录，Panel 会保留任务与原生会话入口。</p></div><div><b>3</b><strong>开始执行</strong><p>直接输入、录音或捕获上下文，然后在电脑上确认和查看结果。</p></div></div></section>
      <section className="site-cta"><p className="site-kicker">VIBE REMOTE / COMPANION</p><h2>需要离开电脑输入？</h2><p>Vibe Remote 是 Vibe Panel 的手机配套入口，用语音和按键追加当前电脑会话。</p><a className="site-secondary-action" href="/remote">了解 Vibe Remote <ArrowRight size={17} /></a></section>
    </main>
    <footer className="site-footer"><span>VIBE PANEL / 2026 · <a href="https://x2v.co" target="_blank" rel="noreferrer">X2V</a> · <a href="https://toolkit.fun" target="_blank" rel="noreferrer">Toolkit</a></span><span><a href="/remote">Vibe Remote</a><a href="/download">下载</a><a href="https://github.com/x2v-co/vibe-coding-panel" target="_blank" rel="noreferrer">GitHub</a><a href="https://aiplans.dev" target="_blank" rel="noreferrer">更多产品</a><a href="/privacy/">隐私</a><a href="/terms/">条款</a></span></footer>
  </div>;
}

function RemoteLandingPage() {
  return <div className="site-shell remote-shell">
    <header className="site-nav"><a className="site-brand" href="/remote"><span className="site-mark"><Smartphone size={16} /></span><span>VIBE REMOTE</span></a><nav><a href="/">Vibe Panel</a><a href="#how-it-works">怎么工作</a><a href="/download#controller-setup">启动 Connector</a><a className="site-nav-action" href="/api/desktop-controller/view">打开遥控器 <ChevronRight size={15} /></a></nav></header>
    <main>
      <section className="site-hero"><div className="site-hero-copy"><p className="site-kicker">VIBE REMOTE / PHONE INPUT</p><h1>手机负责输入，<br /><em>电脑继续工作。</em></h1><p>Vibe Remote 是 Vibe Panel 的配套遥控器。用手机语音和按键追加当前电脑会话，完整草稿与回复留在电脑。</p><div className="site-hero-actions"><a className="site-primary-action" href="/api/desktop-controller/view">打开手机遥控器 <ArrowRight size={17} /></a><a className="site-secondary-action" href="/download#controller-setup">查看启动方式</a></div><span className="site-note"><ShieldCheck size={14} />无需注册；由电脑 Connector 生成一次性配对入口</span></div><div className="site-hero-device remote-hero-device"><div className="site-device-label">VIBE REMOTE / INPUT SURFACE</div><img src="/screenshots/runtime/panel-mobile.png" alt="Vibe Remote 手机输入界面" /></div></section>
      <section className="site-proof"><div><strong>01</strong><span>说</span><p>录音后校对，追加到电脑草稿</p></div><div><strong>02</strong><span>按</span><p>用快捷键和输入模板控制操作</p></div><div><strong>03</strong><span>发</span><p>在手机确认后提交电脑当前会话</p></div></section>
      <section className="site-how" id="how-it-works"><div><p className="site-kicker">THREE STEPS</p><h2>一次连接，<br />随时继续输入。</h2></div><div className="site-steps"><div><b>1</b><strong>在电脑启动控制中心</strong><p>使用 Connector 的控制中心模式，绑定 Codex App、Claude App 或 Claude Code 会话。</p></div><div><b>2</b><strong>扫描二维码配对手机</strong><p>电脑会生成带配对码的一次性入口。手机首次连接后，之后可直接打开遥控器。</p></div><div><b>3</b><strong>手机追加，电脑执行</strong><p>语音和按键只写入电脑草稿；确认发送后，Agent 继续在电脑项目中工作。</p></div></div></section>
      <section className="site-cta"><p className="site-kicker">PART OF VIBE PANEL</p><h2>还没有电脑端连接？</h2><p>先安装 Connector 并打开 Vibe Panel，再从控制中心启用手机遥控。</p><a className="site-secondary-action" href="/">了解 Vibe Panel <ArrowRight size={17} /></a></section>
    </main>
    <footer className="site-footer"><span>VIBE PANEL / 2026 · <a href="https://x2v.co" target="_blank" rel="noreferrer">X2V</a> · <a href="https://toolkit.fun" target="_blank" rel="noreferrer">Toolkit</a></span><span><a href="/remote">Vibe Remote</a><a href="/download">下载</a><a href="https://github.com/x2v-co/vibe-coding-panel" target="_blank" rel="noreferrer">GitHub</a><a href="https://aiplans.dev" target="_blank" rel="noreferrer">更多产品</a><a href="/privacy/">隐私</a><a href="/terms/">条款</a></span></footer>
  </div>;
}
...
function DownloadPage() {
  return <div className="site-shell download-shell">
    <header className="site-nav"><a className="site-brand" href="/"><span className="site-mark"><Sparkles size={16} /></span><span>VIBE PANEL</span></a><nav><a href="/">Vibe Panel</a><a href="/remote">Vibe Remote</a><a className="site-nav-action" href="/app">打开面板 <ChevronRight size={15} /></a></nav></header>
    <main className="download-main"><div className="download-heading"><p className="site-kicker">ONE CONNECTOR / TWO ENTRIES</p><h1>下载 Connector。</h1><p>一个 Connector 同时支持 Vibe Panel 和 Vibe Remote。Agent、项目和配对服务都运行在你的电脑上。</p></div><div className="download-card"><div className="download-card-icon"><Laptop size={24} /></div><div><h2>Vibe Panel Connector</h2><p>内测版 · 自带 Node.js 24 和运行依赖 · 解压即可启动</p><div className="download-packages">{[
      ['darwin-arm64', 'macOS · Apple Silicon'], ['darwin-x64', 'macOS · Intel'],
      ['win32-x64', 'Windows · x64'], ['linux-x64', 'Linux · x64'],
    ].map(([target, label]) => <a key={target} className="site-primary-action" href={`https://github.com/x2v-co/vibe-coding-panel/releases/latest/download/vibe-connector-${target}.zip`}>{label}<ArrowRight size={17} /></a>)}</div><p><a href="https://github.com/x2v-co/vibe-coding-panel/releases/latest">版本记录与 SHA256 校验</a></p></div></div>
      <div className="download-guide" id="controller-setup"><h2>两种入口，一次安装</h2><div className="download-guide-section"><h3>Vibe Panel · 电脑工作台</h3><ol><li><b>启动 Connector</b><span>macOS 双击 <code>Vibe Panel.command</code>；Windows 双击 <code>Vibe Panel.bat</code>；Linux 运行 <code>bash "Vibe Panel.sh"</code>。</span></li><li><b>打开 Panel</b><span>选择已登录的 Codex、Claude App 或 Claude Code，再选择 Workspace，开始创建和继续任务。</span></li></ol></div><div className="download-guide-section"><h3>Vibe Remote · 手机配套遥控器</h3><ol><li><b>在 Connector 启用控制中心</b><span>运行控制中心模式并绑定电脑当前会话，电脑会显示一次性配对二维码。</span></li><li><b>手机扫描二维码</b><span>首次配对后直接打开 Remote；语音和按键追加到电脑草稿，完整过程和回复仍在 Panel 中查看。</span></li></ol></div></div><p className="download-package-note">便携包尚未签名或公证，不是系统安装器。macOS 可能要求在“隐私与安全性”中允许打开；请遵循电脑的安全策略。Linux 需兼容 Node 24 的 glibc 系统（已测试 Ubuntu）。</p><div className="download-help"><ShieldCheck size={17} /><span><a href="https://github.com/x2v-co/vibe-coding-panel/blob/main/README.zh-CN.md">完整安装说明</a> · <a href="https://github.com/x2v-co/vibe-coding-panel/blob/main/docs/install-for-agents.md">让 Agent 安装</a> · 还没安装 Agent？<a href="/app">先用演示模式体验</a>。</span></div></main>
    <footer className="site-footer"><span>VIBE PANEL / 2026 · <a href="https://x2v.co" target="_blank" rel="noreferrer">X2V</a> · <a href="https://toolkit.fun" target="_blank" rel="noreferrer">Toolkit</a></span><span><a href="/">项目介绍</a><a href="/remote">Vibe Remote</a><a href="/app">打开面板</a><a href="https://aiplans.dev" target="_blank" rel="noreferrer">更多产品</a><a href="/privacy/">隐私</a><a href="/terms/">条款</a></span></footer>
  </div>;
}
